    ...
    public partial class testingForm : Form
    {
        ...
        private void NextQuestion()
        {
            while (iterator <= questions.Count - 1)
            {
                ...
                label3.Text = questions[iterator].Question;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show($"You answered {checkTrueAnswers} questions correctly", "Result", MessageBoxButtons.OK, MessageBoxIcon.Information) ;
